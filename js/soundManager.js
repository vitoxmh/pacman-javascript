class soundManager{
    ...
    stopAll() {
        ...
        this.stopFright();
        this.stopEyes();
        if (this.listSound && this.listSound.eatDot) {
            this.listSound.eatDot.pause();
        }
        if (this.frightAudio) this.frightAudio.pause();
        if (this.eyesAudio) this.eyesAudio.pause();
        if (this.sirenAudio) this.sirenAudio.pause();
    }
